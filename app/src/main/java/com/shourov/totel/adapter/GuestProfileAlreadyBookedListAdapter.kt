...
class GuestProfileAlreadyBookedListAdapter(private var itemList: ArrayList<ProfileAlreadyBookedModel?>) :
    RecyclerView.Adapter<GuestProfileAlreadyBookedListAdapter.ItemViewHolder>() {
