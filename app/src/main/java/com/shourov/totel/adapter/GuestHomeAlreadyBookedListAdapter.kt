...
class GuestHomeAlreadyBookedListAdapter(private var itemList: ArrayList<HomeAlreadyBookedModel?>) :
    RecyclerView.Adapter<GuestHomeAlreadyBookedListAdapter.ItemViewHolder>() {
